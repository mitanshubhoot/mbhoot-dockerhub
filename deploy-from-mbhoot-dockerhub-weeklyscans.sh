...
services:
  ...
  dsalta-consumer:
    ...
    environment:
      ...
      # Kafka Topics
      KAFKA_VENDOR_REQUEST_TOPIC: \${KAFKA_VENDOR_REQUEST_TOPIC:-new-vendor-weekly-scan}
      ...
      # Rate Limiting
      KAFKA_CONSUMER_GROUP: \${KAFKA_CONSUMER_GROUP:-new-vendor-weekly-consumer-group}
...
# Kafka Topics
KAFKA_VENDOR_REQUEST_TOPIC=new-vendor-weekly-scan
...
# Rate Limiting
KAFKA_CONSUMER_GROUP=new-vendor-weekly-consumer-group
